...
const fun=async()=>{
    const response=await fetch('/insert-update-employee-form/data')
...
const printdata=((strat,end,obj)=>{
    ...
    var fields=['can_id','fname','lname','email','phone_number','gender','operation'];
    ...
    for(var i=strat;i<end;i++)
    {
        ...
        for(var j=0;j<fields.length;j++)
        {
            ...
            {
                td.innerHTML=`<a href="/insert-update-employee-form/data/${data[i][fields[0]]}">view</a>&emsp;<a href="/insert-update-employee-form/update/${data[i][fields[0]]}">Update</a>&emsp;<a href="/insert-update-employee-form/delete/${data[i][fields[0]]}">delete</a>`;
            }
            else
            {
